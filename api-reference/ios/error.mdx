...
| -5    | The SDP of the WebRTC client fails to be created. Generally, the ICE Server is abnormal.                                   |
| -6    | The SDP on the WebRTC client fails to be set. Generally, the ICE Server is abnormal.                                       |
...
| 40001 | The server appid or appSecret is invalid                                                                                   |
