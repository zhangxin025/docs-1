...
The domain name used to call the OpenAPI is `https://app.duix.ai/`
...
|profile | String | body |  profile to power your avatar chat. if not empty,  conversation will be automatically created after training| N        |
...
**Note**:
1. When training with a photo, photo should be  jpg/png, max size is 10MB  , the recommended resolution is 1080p and the ratio photo should be 9:16  or 16:9.
