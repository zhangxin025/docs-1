...
<CardGroup cols="2">
  <Card title="Developer Portal" icon="sparkles" color="#f14acc" href="https://duix.com/platform/cases">
  ...
  <Card title="Contact Us" icon="sparkles" color="#eb4ccf" href="mailto:james@duix.com">
